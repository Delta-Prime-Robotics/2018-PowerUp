...
public class Robot extends TimedRobot {
    ...
    public static SendableChooser<String> frontInversionChooser;
    public static OI oi;
    ...
    public void robotInit() {
        ...
        frontInversionChooser = new SendableChooser<String>();
        ...
        frontInversionChooser.addDefault("Claw Front", "Claw");
        frontInversionChooser.addObject("Climb Front", "lift");
    ...
    public void autonomousInit() {
        ...
        // TODO: Add loop to check for game data
    	String gameData = DriverStation.getInstance().getGameSpecificMessage();
        
        switch (startPositionChooser.getSelected())
        {
	        case "L":
	        	autonomousCommand = new LeftAutonomousCommand(gameData);
	        	break;
	        case "R":
	        	autonomousCommand = new RightAutonomousCommand(gameData);
	        	break;	        	
        	default:
	        	autonomousCommand = new MiddleAutonomousCommand(gameData);
	        	break;
        }
