...
public class RobotMap {
    ...
    public static SpeedController armgrabbyVic;
	...
	public static void init() {
        ...
        armgrabbyVic = new VictorSP(5);
        LiveWindow.addActuator("arm", "grabbyVic", (VictorSP) armgrabbyVic);
        armgrabbyVic.setInverted(false);
