...
public class RobotMap {
	...
	public static void init() {
        ...
        liftrightLiftVic = new VictorSP(4);
        LiveWindow.addActuator("lift", "rightLiftVic", (VictorSP) liftrightLiftVic);
        liftrightLiftVic.setInverted(false);
        
        armgrabbyCompressor = new Compressor(0); //Values to check
        hug = new Solenoid(0); //Values to check
        
        clawLiftVic = new VictorSP(5);
